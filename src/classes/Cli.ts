...
class Cli {
  ...
  // xTODO: Update the constructor to accept Truck and Motorbike objects as well
  ...
  createCar(): void {
    inquirer
      ...
      .then((answers) => {
        const car = new Car(
          // xTODO: The generateVin method is static and should be called using the class name Cli, make sure to use Cli.generateVin() for creating a truck and motorbike as well!
          Cli.generateVin(),
          answers.color,
          answers.make,
          answers.model,
  ...
  createTruck(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        this.vehicles.push(myTruck)
        // xTODO: set the selectedVehicleVin to the vin of the truck
        this.selectedVehicleVin = myTruck.vin
    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const myMotorbike = new Motorbike(
          ...
          this.vehicles.push(myMotorbike)

        // xTODO: set the selectedVehicleVin to the vin of the motorbike
        this.selectedVehicleVin = myMotorbike.vin
  ...
  // xTODO: add a parameter to accept a truck object
  findVehicleToTow(truck: Truck): void {
    inquirer
      ...
      .then((answers) => {
        // xTODO: check if the selected vehicle is the truck
  ...
  performActions(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // xTODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
